...
class DriftStack:
    ...
    async def close(self) -> None:
        # Every subscriber started in build() (dlob, drift_client, user_map,
        # slot_subscriber) must be torn down here, or the websocket
        # connections it opened leak past watcher shutdown.
        for obj in (self._dlob, self._drift_client, self._user_map, self._slot_subscriber):
