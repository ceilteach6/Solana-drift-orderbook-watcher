...
class DriftStack:
    ...
    def __init__(
        ...
        # Also subscribed in build() and must be torn down in close(), same as
        # drift_client/dlob — otherwise their websocket subscriptions (and the
        # background tasks driving them) outlive the watcher on shutdown.
