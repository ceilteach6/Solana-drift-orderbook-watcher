...
Layering / spoofing-like detector: a stack of similarly-sized orders on a
single side of the book forms a "wall" intended to create the illusion of
depth. We flag a side when one size cluster spans at least
``LAYERING_MIN_LEVELS`` levels on that side.
"""
